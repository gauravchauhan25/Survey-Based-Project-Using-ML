...
const kpiStats = [
  {
    label: "Average Awareness Index",
    value: "0.78",
    color: "text-blue-700",
    bg: "bg-blue-50",
  },
  {
    label: "Average DPDP Awareness",
    value: "1.20",
    change: "average of dpdp_score",
    color: "text-yellow-600",
    bg: "bg-yellow-50",
  },
  {
    label: "Average IT Awareness",
    value: "0.46",
    change: "average of it_act_score",
    color: "text-rose-600",
    bg: "bg-rose-50",
  },
  {
      ...
      <div className="bg-gradient-to-r from-slate-900 to-blue-900 py-14 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-blue-200 text-lg">
            Visual insights from survey responses collected across India
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
          {kpiStats.map((s) => (
            <div
              key={s.label}
              className={`rounded-2xl p-5 ${s.bg} border border-white`}
            >
        ...
        <div className="mt-8 glass-card text-center py-8">
          ...
          <p className="text-slate-500 text-sm max-w-md mx-auto">
            To embed your Power BI dashboard, replace this section with your
            Power BI iframe embed code from the "Publish to Web" option in Power
            BI service.
          </p>
