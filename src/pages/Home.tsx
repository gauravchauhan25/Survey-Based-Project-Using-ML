...
import {
  ArrowRight, Shield, Lock, FileText, AlertTriangle,
  Users, BookOpen, TrendingUp, ChevronRight, CheckCircle,
  Zap, Globe, Eye
} from 'lucide-react';
...
const actCards = [
  {
    ...
    highlights: ['Section 43 — Data protection', 'Section 66 — Cybercrime', 'Section 72 — Privacy breach'],
    link: '/know-the-acts',
  ...
  },
  {
    ...
    highlights: ['Consent-based data processing', 'Right to erasure & correction', 'Penalties up to ₹250 crore'],
    link: '/know-the-acts',
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 relative z-10">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 text-blue-100 text-sm font-medium mb-6">
              ...
              Survey-Based Data Science Research Project
            </div>
            ...
            <p className="text-blue-100 text-lg md:text-xl leading-relaxed mb-10 max-w-2xl">
              A comprehensive survey exploring awareness of data privacy laws — the{' '}
              <strong className="text-white">IT Act, 2000</strong> and the{' '}
              <strong className="text-white">DPDP Act, 2023</strong> — among college students across India.
            </p>

            <div className="flex flex-wrap gap-4">
              <Link to="/questionnaire" className="btn-accent text-base px-8 py-4">
                Form
                <ArrowRight className="w-5 h-5" />
              </Link>
              <Link to="/analysis" className="btn-outline-white text-base px-8 py-4">
                Explore Insights
            ...
            <div className="mt-12 grid grid-cols-3 gap-6 max-w-lg">
              {[
                ...
                <div key={s.label} className="text-center">
                  <div className="text-2xl font-bold text-yellow-400">{s.num}</div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="section-badge bg-blue-100 text-blue-700">The Laws</span>
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900">
              India's Data Privacy Framework
            </h2>
            <p className="text-slate-500 mt-3 max-w-xl mx-auto text-lg">
              Two landmark laws shaping how personal data is collected, stored, and used in India.
            </p>
          </div>
            ...
            {actCards.map((card) => (
              ...
              >
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    <span className={`text-xs font-bold px-2.5 py-1 rounded-full ${card.tagColor}`}>
                      {card.tag}
                    </span>
                    <h3 className="text-xl font-bold text-slate-900 mt-2">{card.title}</h3>
                  </div>
                </div>
                ...
                <div className="mt-auto">
                  <Link to={card.link} className="btn-primary text-sm px-5 py-2.5">
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="section-badge bg-yellow-100 text-yellow-700">Did You Know?</span>
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {didYouKnowFacts.map((fact) => (
              <div key={fact.stat} className={`rounded-2xl border p-6 card-hover ${fact.color}`}>
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 ${fact.iconBg}`}>
                  {fact.icon}
                </div>
                <div className="text-4xl font-extrabold mb-2">{fact.stat}</div>
                <p className="text-sm leading-relaxed opacity-80">{fact.text}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className={`w-14 h-14 rounded-2xl flex items-center justify-center text-white mb-5 ${item.bg}`}>
                  {item.icon}
                </div>
      ...
      <section className="py-20 hero-bg relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-blue-100 text-lg mb-8">
            Help us understand the state of data privacy awareness in India. The survey takes under 5 minutes and contributes to real research.
          </p>
